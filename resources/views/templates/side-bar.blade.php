...
<div class="sidenav">
    ...
    <a href="{{url('heap-viz')}}">- Heap visualization </a>
    <a href="{{url('graphs')}}">- Graphs: adjacency list, adjacency matrix, incidence matrix </a>
    <a href="{{url('graph-search')}}">- Graphs: breadth-first search</a>
</div>
